...
const Departments = () => {
  ...
  async function fetchData() {
    ...
    try {
      responseDepartments = await axios.get(
        `/departments?per_page=${perPage}&page=${
      ...
      setPageObject({
        ...
        isLoading: false,
        isListEmpty: !responseDepartments.data.data.data.length ? true : false,
        tableTotalPages: responseDepartments.data.data.total,
      });
    } catch (error) {
      console.log(error);
    }
  ...
  const [toastContent, setToastContent] = useState(
    "This departments has been successfully deleted"
  );
