...
const JobTitles = () => {
  ...
  async function fetchData() {
    ...
    try {
      ...
      setPageObject({
        ...
        isLoading: false,
        isListEmpty: !responseJobTitles.data.data.data.length ? true : false,
        tableTotalPages: responseJobTitles.data.data.total,
      });
    } catch (error) {
      console.log(error);
    }
  ...
  const [toastContent, setToastContent] = useState(
    "This job title has been successfully deleted"
  );
